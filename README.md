...
<br><br>
 ...
 <p align="center"> 한번 쯤 이용해봤을 호텔예약 사이트를 만들고 싶었습니다. <br><br>
                    ...
                    고객의 말을 귀 기울이는  <b>K-HOTEL</b>를 만들어 나가겠습니다. <br><br><br></p>
...
<p align="center" dir="auto"> 
  코로나 19로 비교적 안전한 호텔에서 바캉스를 즐기는 <b>'호캉스'</b> 인기를 끌고 있습니다. <br><br>
  이에 따라 소비자를 위한 편리한 예약사이트를 구상하여<br> 웹 플랫폼 K-HOTEL를 개발하게 되었습니다.<br>
  이 웹페이지는 쉽게 정보를 얻을 수 있는 UX/UI, 효율적인 리뷰시스템, 좋아요 기능을 통해 <br>사용자 중심의 반응형 웹을 제공합니다. 
